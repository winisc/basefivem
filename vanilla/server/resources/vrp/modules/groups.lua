...
function vRP.ServiceEnter(Source, Passport, Permission, Silenced)
    if Characters[Source] then
        ...
        if GroupBlips[Permission] then
            TriggerEvent("markers:Enter", Source, Permission, true)
        end
        ...
        if not Silenced then
            TriggerClientEvent("Notify",Source,"verde","Entrou em serviço.","Sucesso",5000)
        end
    end
end
-----------------------------------------------------------------------------------------------------------------------------------------
...
function vRP.ServiceLeave(Source, Passport, Permission, Silenced)
    if Characters[Source] then
        ...
        if GroupBlips[Permission] then
            TriggerEvent("markers:Exit", Source)
        ...
        if not Silenced then
            TriggerClientEvent("Notify",Source,"verde","Saiu de serviço.","Sucesso",5000)
        end
    end
end
-----------------------------------------------------------------------------------------------------------------------------------------
