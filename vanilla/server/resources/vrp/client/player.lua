...
AddEventHandler("vRP:Active",function(Passport,Name)
	...
	SetDiscordAppId(960174652569813032)
	SetDiscordRichPresenceAsset("vanilla")
	SetDiscordRichPresenceAssetSmall("vanilla")
	SetRichPresence(Passport.." - "..Name)
	SetDiscordRichPresenceAssetText("vanilla")
	SetDiscordRichPresenceAssetSmallText("vanilla")
